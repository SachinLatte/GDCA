<?php include "head.php" ?>
    <section class="common-top-banner">
        <img src="assets/img/mpl-top-banner.jpg" alt="" class="deskblock">
        <img src="assets/img/mpl-top-banner-mobile.jpg" alt="" class="mob-block">
    </section>
    <!-- ======= About Section ======= -->
    ...
    <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          <div class="col-lg-12 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h1 class="common-heading">Madhya Pradesh League for the Scindia Cup</h1>
              <img src="assets/img/mpl-logo.png" alt="logo" class="logoimg">
              <p>
    ...
    <section class="teams-section" data-aos="fade-up" data-aos-delay="400">
        <div class="container">
            <div class="client_main_block">
                <div class="main_grid mrgtp">
                    <!-- <div class="client_img">
                        <img src="assets/img/mpl-logo.png" alt="">
                    </div> -->
                    <div class="client_img">
                        <img src="assets/img/Gwalior-Cheetahs.png" alt="">
                    </div>
                    <div class="client_img">
                        <img src="assets/img/Mahakoshal-Lions.png" alt="">
                    </div>
                    <div class="client_img">
                        <img src="assets/img/Malwa-Panthers.png" alt="">
                    </div>
                    <div class="client_img">
                        <img src="assets/img/Rewa-Jaguars.png" alt="">
                    </div>
                    <div class="client_img">
                        <img src="assets/img/Satpura-Leopards.png" alt="">
                    </div>
                </div>
            </div>
        </div>
